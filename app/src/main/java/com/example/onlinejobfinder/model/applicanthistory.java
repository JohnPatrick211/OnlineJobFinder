...
public class applicanthistory {
    ...
    public applicanthistory(String savedid, String jobstatus, String jobuniqueid, String jobdescription, String jobid, String joblocation, String jobcategory, String joblogo, String jobtitle, String jobcompany, String jobaddress, String jobsalary, String companyoverview, String jobdateposted, String countapplicants) {
        this.savedid = savedid;
        this.jobstatus = jobstatus;
        this.jobuniqueid = jobuniqueid;
        this.jobdescription = jobdescription;
