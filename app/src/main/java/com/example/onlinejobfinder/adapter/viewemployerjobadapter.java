...
public class viewemployerjobadapter extends RecyclerView.Adapter<viewemployerjobadapter.Viewholder> implements Filterable {


    public viewemployerjobadapter(ArrayList<job> listjob, Context context, RecyclerViewClickListener listener) {
   ...
   private RecyclerViewClickListener listener;
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.cardview_view_viewemployerjobs,parent,false);
