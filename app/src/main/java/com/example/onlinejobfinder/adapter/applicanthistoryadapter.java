...
public class applicanthistoryadapter extends RecyclerView.Adapter<applicanthistoryadapter.Viewholder> implements Filterable {


    public applicanthistoryadapter(ArrayList<applicanthistory> listjob, Context context, RecyclerViewClickListener listener) {
    ...
    private ArrayList<applicanthistory> listjob;
    private Context context;
    private List<applicanthistory> categorysearch;
   private RecyclerViewClickListener listener;
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.cardview_view_applicanthistory,parent,false);
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        applicanthistory job2 = listjob.get(position);
...
//        holder.txtview_jobdateposted.setText(job2.getJobdateposted().trim());
        holder.txtview_countapplicants.setText(job2.getJobstatus());
        job2.getJobaddress();
    ...
    public Filter categoryfilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ArrayList<applicanthistory> filterList = new ArrayList<>();
            if (charSequence == null || charSequence.length() ==0){
                filterList.addAll(categorysearch);
            }
            else {
                String filterPattern = charSequence.toString().toLowerCase().trim();
                for (applicanthistory item : categorysearch){
...
//                Toast.makeText(context,position,Toast.LENGTH_SHORT).show();
    ...
    public void setWinnerDetails(ArrayList<applicanthistory> listjob)
    {
        this.listjob = listjob;
        notifyDataSetChanged();
    }
