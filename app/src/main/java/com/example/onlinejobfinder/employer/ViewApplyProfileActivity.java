...
public class ViewApplyProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_apply_profile);
        ...
        recyclerView2.setLayoutManager(new LinearLayoutManager(ViewApplyProfileActivity.this));
        recyclerView.setLayoutManager(new LinearLayoutManager(ViewApplyProfileActivity.this));
...
//        Toast.makeText(ViewAcceptRejectApplicantActivity.this,  val_id, Toast.LENGTH_SHORT).show();
        ...
        StringRequest request = new StringRequest(Request.Method.GET, Constant.MY_POST+"?applicant_id="+applicant_id, response -> {
            try{
                ...
                {
                    Toast.makeText(ViewApplyProfileActivity.this, "Error Occurred, Please try again", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ViewApplyProfileActivity.this,error.getMessage(),Toast.LENGTH_SHORT).show();
            txtname.setText(name2);
            txtemail.setText(email);
            // progressDialog.cancel();
        })
        ...
        RequestQueue queue = Volley.newRequestQueue(ViewApplyProfileActivity.this);
        queue.add(request);
    }
    public void onResume() {
        ...
        StringRequest request2 = new StringRequest(Request.Method.GET, Constant.geteducation+"?educational_id="+applicant_id, response ->{
            try{
                ...
                if(object.getBoolean("success"))
                {
                    ...
                    educationalbackgroundadapter = new vieweducationalbackgroundadapter(arraylist,ViewApplyProfileActivity.this);
                    recyclerView.setAdapter(educationalbackgroundadapter);
                    educationalbackgroundadapter.notifyDataSetChanged();

                }
                else {
                    Toast.makeText(ViewApplyProfileActivity.this,"error",Toast.LENGTH_SHORT).show();
            ...
            }catch(JSONException e)
            {
                recyclerView.setVisibility(View.GONE);
                e.printStackTrace();
                Toast.makeText(ViewApplyProfileActivity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
            }
        ...
        RequestQueue queue2 = Volley.newRequestQueue(ViewApplyProfileActivity.this);
        queue2.add(request2);
        ...
        StringRequest request3 = new StringRequest(Request.Method.GET, Constant.getworkexperience+"?workexp_id="+applicant_id, response ->{
            try{
                ...
                if(object.getBoolean("success"))
                {
                    ...
                    workexperienceadapter2 = new viewworkexperienceadapter(arraylist2,ViewApplyProfileActivity.this);
        ...
        RequestQueue queue3 = Volley.newRequestQueue(ViewApplyProfileActivity.this);
        queue3.add(request3);
    }
    public void delay()
    {
