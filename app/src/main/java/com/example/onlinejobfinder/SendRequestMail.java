...
public class SendRequestMail extends AsyncTask<Void,Void,Void> {
    ...
    //Class Constructor
    public SendRequestMail(Context context, String email, String email2, String subject, String message, String sender){
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        Toast.makeText(context,"Request Maintenance Sent",Toast.LENGTH_LONG).show();
    }
